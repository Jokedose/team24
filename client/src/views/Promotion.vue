...
//   import axios from "../../src/api/http_request";
    ...
    import Baggage from '../components/Promotion/Promotions.vue'
  export default {
    name: 'AddsOn',
    components: {
        NavBar,
    ...
    // getBaggagetype() {
    //   axios.http
    //     .get("http://172.17.0.200/baggagetype")
    //     .then(bag => {
    ...
    // getImage() {
    //   axios.http
    //     .get("http://172.17.0.200/bagimage")
    //     .then(bimage => {
...
.my-bg {
  padding-top: 100px;
  background: url("https://hdqwalls.com/wallpapers/person-walking-on-road-with-suitcase-kv.jpg") center center;
  min-height: 100vh;
  height: 50%;
  margin: 0px;
...
.my-content{
  background-color: rgba(300, 300, 300, 0.900);
  border-radius: 30px;
  padding:30px;
}
</style>
